...
export default function ResultDisplay({ valor, distancia, paradas, custosExtras, settings, mode }) {
  ...
  const handleShare = async () => {
    const modeLabel = mode === 'ml' ? 'Mercado Livre Flex' : 'Lalamove';
    const text =
      `🚚 Vale o Frete? — ${modeLabel}\n` +
      `📏 ${distancia} km${paradas ? ` • ${paradas} paradas` : ''}\n` +
  ...
  return (
    <div>
      ...
      <div className="result-grid">
        ...
        <div className="result-item">
          <div className="label">📏 R$/km Líquido</div>
