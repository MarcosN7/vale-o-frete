...
export const ANP_PRICES = {
  AC: { gasolina: 6.49, etanol: 5.19, diesel: 6.89, nome: 'Acre' },
  AL: { gasolina: 5.89, etanol: 4.09, diesel: 5.99, nome: 'Alagoas' },
  AP: { gasolina: 6.19, etanol: 5.29, diesel: 6.49, nome: 'Amapá' },
  AM: { gasolina: 6.29, etanol: 5.39, diesel: 6.39, nome: 'Amazonas' },
  BA: { gasolina: 5.79, etanol: 4.19, diesel: 5.89, nome: 'Bahia' },
  CE: { gasolina: 5.69, etanol: 4.29, diesel: 5.95, nome: 'Ceará' },
  DF: { gasolina: 5.79, etanol: 4.39, diesel: 5.99, nome: 'Distrito Federal' },
  ES: { gasolina: 5.89, etanol: 3.99, diesel: 5.89, nome: 'Espírito Santo' },
  GO: { gasolina: 5.69, etanol: 3.89, diesel: 5.85, nome: 'Goiás' },
  MA: { gasolina: 5.89, etanol: 4.29, diesel: 5.89, nome: 'Maranhão' },
  MT: { gasolina: 5.89, etanol: 3.89, diesel: 6.19, nome: 'Mato Grosso' },
  MS: { gasolina: 5.69, etanol: 3.89, diesel: 5.99, nome: 'Mato Grosso do Sul' },
  MG: { gasolina: 5.79, etanol: 3.99, diesel: 5.89, nome: 'Minas Gerais' },
  PA: { gasolina: 5.99, etanol: 4.59, diesel: 6.19, nome: 'Pará' },
  PB: { gasolina: 5.79, etanol: 4.29, diesel: 5.89, nome: 'Paraíba' },
  PR: { gasolina: 5.69, etanol: 3.99, diesel: 5.85, nome: 'Paraná' },
  PE: { gasolina: 5.79, etanol: 4.19, diesel: 5.89, nome: 'Pernambuco' },
  PI: { gasolina: 5.89, etanol: 4.39, diesel: 5.99, nome: 'Piauí' },
  RJ: { gasolina: 6.09, etanol: 4.79, diesel: 6.05, nome: 'Rio de Janeiro' },
  RN: { gasolina: 5.79, etanol: 4.29, diesel: 5.99, nome: 'Rio Grande do Norte' },
  RS: { gasolina: 5.89, etanol: 4.49, diesel: 5.99, nome: 'Rio Grande do Sul' },
  RO: { gasolina: 6.09, etanol: 4.79, diesel: 6.29, nome: 'Rondônia' },
  RR: { gasolina: 6.29, etanol: 5.09, diesel: 6.59, nome: 'Roraima' },
  SC: { gasolina: 5.69, etanol: 4.19, diesel: 5.89, nome: 'Santa Catarina' },
  SP: { gasolina: 5.89, etanol: 3.89, diesel: 5.89, nome: 'São Paulo' },
  SE: { gasolina: 5.89, etanol: 4.29, diesel: 5.89, nome: 'Sergipe' },
  TO: { gasolina: 5.99, etanol: 4.59, diesel: 6.09, nome: 'Tocantins' },
};
